...
const CACHE_NAME = 'medbi-cache-v31'; // v31: adiciona ícones e manifest ao cache
const FILES_TO_CACHE = [
  '/MEDBIrepo/',
  '/MEDBIrepo/index.html',
  '/MEDBIrepo/manifest.json',
  '/MEDBIrepo/icon-192.png',
  '/MEDBIrepo/icon-512.png',
  '/MEDBIrepo/icon-512-maskable.png'
];
